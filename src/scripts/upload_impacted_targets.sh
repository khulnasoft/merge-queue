...
# API URL
if [[ -z ${API_URL+x} ]]; then
	API_URL="https://api.khulnasoft.com:443/v1/setImpactedTargets"
fi
...
if [[ ${HTTP_STATUS_CODE} == 200 ]]; then
	...
	EXIT_CODE=1
	COMMENT_TEXT="❌ Unable to upload impacted targets. Encountered ${HTTP_STATUS_CODE} @ ${PR_SHA}. Please contact us at slack.khulnasoft.com."
